...
static Canard::Publisher<dronecan_remoteid_Location_cxx_iface>* dc_location[HAL_MAX_CAN_PROTOCOL_DRIVERS];
static Canard::Publisher<dronecan_remoteid_BasicID_cxx_iface>* dc_basic_id[HAL_MAX_CAN_PROTOCOL_DRIVERS];
static Canard::Publisher<dronecan_remoteid_SelfID_cxx_iface>* dc_self_id[HAL_MAX_CAN_PROTOCOL_DRIVERS];
static Canard::Publisher<dronecan_remoteid_System_cxx_iface>* dc_system[HAL_MAX_CAN_PROTOCOL_DRIVERS];
static Canard::Publisher<dronecan_remoteid_OperatorID_cxx_iface>* dc_operator_id[HAL_MAX_CAN_PROTOCOL_DRIVERS];

static Canard::ArgCallback<AP_UAVCAN, dronecan_remoteid_ArmStatus> *arm_status_callback[HAL_MAX_CAN_PROTOCOL_DRIVERS];
static Canard::Subscriber<dronecan_remoteid_ArmStatus_cxx_iface> *arm_status_listener[HAL_MAX_CAN_PROTOCOL_DRIVERS];
...
void AP_OpenDroneID::dronecan_init(AP_UAVCAN *uavcan)
{
    ...
    dc_location[driver_index] = new Canard::Publisher<dronecan_remoteid_Location_cxx_iface>(uavcan->get_canard_iface());
    ...
    dc_basic_id[driver_index] = new Canard::Publisher<dronecan_remoteid_BasicID_cxx_iface>(uavcan->get_canard_iface());
    ...
    dc_self_id[driver_index] = new Canard::Publisher<dronecan_remoteid_SelfID_cxx_iface>(uavcan->get_canard_iface());
    ...
    dc_system[driver_index] = new Canard::Publisher<dronecan_remoteid_System_cxx_iface>(uavcan->get_canard_iface());
    ...
    dc_operator_id[driver_index] = new Canard::Publisher<dronecan_remoteid_OperatorID_cxx_iface>(uavcan->get_canard_iface());
    ...
    arm_status_callback[driver_index] = new Canard::ArgCallback<AP_UAVCAN, dronecan_remoteid_ArmStatus>(uavcan, &handle_arm_status);
    arm_status_listener[driver_index] = new Canard::Subscriber<dronecan_remoteid_ArmStatus_cxx_iface>(*arm_status_callback[driver_index], driver_index);
